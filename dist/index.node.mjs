import { createContext, Component, createElement, Children, useReducer, useState, useContext, useRef } from 'react';
...
const WistiaContext = /*#__PURE__*/createContext();
...
class WistiaChannel extends Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return this.state.safeToRender ? /*#__PURE__*/createElement("div", {
...
class WistiaPlayer extends Component {
  ...
  get isPopover() {
    return isUndefined(this.props.popover) ? Children.count(this.props.children) !== 0 : this.props.popover;
  }
  get isPopoverLink() {
  ...
  render() {
    ...
    if (this.props.videoFoam) {
      ...
      return /*#__PURE__*/createElement("div", {
        ...
        key: this.props.hashedId,
        style: this.style
      }, this.isPopover && this.isPopoverLink ? /*#__PURE__*/createElement("a", {
        href: "#"
      }, this.props.children) : ' ')));
    } else {
      return /*#__PURE__*/createElement("div", {
  ...
  setupEventBindings(player) {
    const bindToEvent = (event, handler) => {
      ...
      player.bind(normalizedEventName, (...args) => {
        ...
        (_this$event = this[event]) === null || _this$event === void 0 ? void 0 : _this$event.call(this, ...args);
...
_defineProperty(WistiaPlayer, "propTypes", {
  ...
  qualityMax: propTypes.oneOfType([propTypes.number, propTypes.oneOf(['360p', '540p', '720p', '1080p', '4k'])]),
  qualityMin: propTypes.oneOfType([propTypes.number, propTypes.oneOf(['360p', '540p', '720p', '1080p', '4k'])]),
  ...
  videoFoam: propTypes.oneOfType([propTypes.bool, propTypes.shape({
...
class HeadResult {
  ...
  addExternalScript(src) {
    this.head.push( /*#__PURE__*/createElement("script", {
      async: true,
      key: src,
      src: src,
      type: MEDIA_TYPE_JS
  ...
  setCanonical(...preservedKeys) {
    ...
    this.canonical = /*#__PURE__*/createElement("link", {
      href: url.href,
      key: "canonical",
      rel: "canonical"
    });
  ...
  setSeriesRelation(rel, usp) {
    ...
    const url = new URL(this.url);
    url.search = usp;
    this.seriesRelations.set(rel, /*#__PURE__*/createElement("link", {
      href: url.href,
      key: rel,
      rel: rel
    }));
  ...
  setTitle(...items) {
    ...
    if (title) {
      this.title = /*#__PURE__*/createElement("title", {
        key: "wistia-title"
      }, title);
    }
  }
...
function useHeadManager({
  ...
  const headManager = useRef(new HeadManager({
    href,
    origin
  }));
...
function WistiaProvider(props) {
  ...
  return /*#__PURE__*/createElement(WistiaContext.Provider, {
    value: value
  }, children);
}
...
export { WistiaChannel, WistiaPlayer, WistiaProvider, usePlayer };
